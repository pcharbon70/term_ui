defmodule TermUI.Widgets.Block do
  @moduledoc """
  ...
  def render(state, area) do
    ...
    border_chars = border_chars(border_type, CharacterSet.current_charset())
  ...
  defp border_chars(:none, _chars) do
    %{tl: " ", tr: " ", bl: " ", br: " ", h: " ", v: " "}
  end

  defp border_chars(:single, chars) do
    %{tl: chars.tl, tr: chars.tr, bl: chars.bl, br: chars.br, h: chars.h_line, v: chars.v_line}
  end

  defp border_chars(:double, chars) do
    %{
      tl: chars.tl_double,
      tr: chars.tr_double,
      bl: chars.bl_double,
      br: chars.br_double,
      h: chars.h_line_double,
      v: chars.v_line_double
    }
  end

  defp border_chars(:rounded, chars) do
    %{
      tl: chars.tl_round,
      tr: chars.tr_round,
      bl: chars.bl_round,
  ...
  defp border_chars(:thick, chars) do
    %{
      tl: chars.tl_heavy,
      tr: chars.tr_heavy,
      bl: chars.bl_heavy,
      br: chars.br_heavy,
      h: chars.h_line_heavy,
      v: chars.v_line_heavy
    }
  end

  defp border_chars(_unknown, chars), do: border_chars(:single, chars)
